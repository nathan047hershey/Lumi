...
export const userAPI = {
    ...
    prepareBidderPacket: (payload) => api.post('/user/bidder/prepare-packet', payload, { timeout: 180000 }),
    getBidderPacketStatus: (payload) => api.post('/user/bidder/packet-status', payload),
    getBidderPacket: (applicationId) => api.get(`/user/bidder/packet/${applicationId}`),
    updateBidderPacketAnswer: (applicationId, payload) =>
        api.patch(`/user/bidder/packet/${applicationId}`, payload),
