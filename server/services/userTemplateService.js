...
// The default template every new user starts with. Same Brandon layout
// as the system default in templateService.js.
function defaultStyleSpec() {
    return JSON.parse(JSON.stringify(templateService.DEFAULT_STYLE_SPEC));
}
