...
// row waits BASE * 2^(N-1). Default 45s → 90s → 180s → … (was 5m which
// made a single failed job look “stuck” for minutes).
const BACKOFF_BASE_MS = parseInt(process.env.JOB_LINKS_BACKOFF_BASE_MS || 45 * 1000, 10);
